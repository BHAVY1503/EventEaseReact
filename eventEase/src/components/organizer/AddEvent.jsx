...
// mapboxgl.accessToken = import.meta.env.VITE_MAPBOX_TOKEN; // ✅ Load public token
...
//     <div className="container mt-5">
//       <h2 className="text-center mb-4">Add Event</h2>
//       <form onSubmit={handleSubmit(submitHandler)} className="shadow p-4 border rounded bg-light">
//         <div className="row">
//           <div className="col-md-6 mb-3">
//             <label>Event Name</label>
