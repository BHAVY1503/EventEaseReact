...
import { ServerIcon } from '@heroicons/react/24/solid'; // ✅ not /20 or /16
import { ChevronDownIcon } from '@heroicons/react/16/solid'

export const UI = () => {
  return (
      <div className="container isolate bg-light dark:bg-gray-800 h-100 w-auto px-500 py-500 sm:py-300 lg:px-300 shadow-xl shadow-xl/30">
      <div
        aria-hidden="true"
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm  shadow-cyan-500/50 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
