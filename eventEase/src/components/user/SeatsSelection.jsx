...
//       <div className="accordion" id="zoneAccordion">
//         {event?.stadiumId?.zones?.map((zone, index) => (
//           <div className="accordion-item" key={index}>
//             <h2 className="accordion-header" id={`heading-${index}`}>
//               <button
//                 className="accordion-button collapsed"
...
//           selectedSeats,
//           organizerId: event.organizerId,
//           stateId: event.stateId?._id,
//           cityId: event.cityId?._id,
//         },
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
...
//           <h5>Zone {String.fromCharCode(65 + index)} - ₹{zone.price}</h5>
//           <div className="d-flex flex-wrap gap-2">
//             {zone.seatLabels.map((seat, i) => (
//               <div
//                 key={i}
