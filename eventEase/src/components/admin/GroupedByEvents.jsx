                        ...
                        return (
                          <Card key={event._id} className="overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            <CardContent className="p-4 space-y-3">
                              ...
                              {/* Booking Section */}
                              {/* {!eventEnded && availableSeats > 0 && event.isApproved && (
                                <div className="space-y-3 pt-3 border-t">
                                  {event.eventCategory === "Indoor" ? (
                                    <Link to={`/select-seats/${event._id}`}>
                                      <Button className="w-full">
                                        <Ticket className="w-4 h-4 mr-2" /> Select Seats
                                      </Button>
                                    </Link>
                                  ) : event.eventCategory === "ZoomMeeting" ? (
                                    <a href={event.zoomMeetingUrl} target="_blank" rel="noopener noreferrer">
                                      <Button className="w-full">
                                    ...
                                    <>
                                      ...
                                      >
                                        {bookingLoading[event._id] ? (
                                          ...
                                          <>
                                            <Ticket className="w-4 h-4 mr-2" /> Book {currentQuantity} Seat{currentQuantity > 1 ? "s" : ""}
                                          </>
                                        )}
                                      </Button>
                                    </>
                            ...
                            <CardFooter className="p-4 bg-gray-50 flex space-x-2">
                              ...
                              >
                                {deleteLoading[event._id] ? <Loader2 className="w-4 h-4 mr-1 animate-spin" /> : <Trash2 className="w-4 h-4 mr-1" />}
                                Delete
                              </Button>
                            </CardFooter>
                          </Card>
